...
// This file (UoeProcessIoTest.cs) is part of Oetools.Utilities.Test.
//
...
namespace Oetools.Utilities.Test.Openedge.Execution {
    ...
    [TestClass]
    public class UoeProcessIoTest {

        private static string _testFolder;
        private bool _hasExited1;
        private bool _hasExited2;

        private static string TestFolder => _testFolder ?? (_testFolder = TestHelper.GetTestFolder(nameof(UoeProcessIoTest)));
