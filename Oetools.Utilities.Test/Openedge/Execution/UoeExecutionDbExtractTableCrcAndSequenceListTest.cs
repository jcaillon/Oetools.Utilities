...
namespace Oetools.Utilities.Test.Openedge.Execution {
    ...
    [TestClass]
    public class UoeExecutionDbExtractTableCrcAndSequenceListTest {

        private static string _testFolder;

        private static string TestFolder => _testFolder ?? (_testFolder = TestHelper.GetTestFolder(nameof(UoeExecutionDbExtractTableCrcAndSequenceListTest)));
