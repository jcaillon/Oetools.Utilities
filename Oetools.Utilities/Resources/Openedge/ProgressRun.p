...
/* in batch mode, we hide any message caused by a runtime/compile error so this procedure might not
   go till the end correctly (and yet the process would exit with code 0)
