...
namespace Oetools.Utilities.Openedge.Execution {
    ...
    /// </summary>
    public abstract class AUoeExecution : IDisposable {

        /// <summary>
        /// The action to execute just after the end of a prowin process
        /// </summary>
        public event Action<AUoeExecution> OnExecutionEnd;

        /// <summary>
        /// The action to execute at the end of the process if it went well
        /// </summary>
        public event Action<AUoeExecution> OnExecutionOk;

        /// <summary>
        /// The action to execute at the end of the process if something went wrong
        /// </summary>
        public event Action<AUoeExecution> OnExecutionException;
        ...
        public AUoeExecution(AUoeExecutionEnv env) {
            Env = env;
