...
// This file (ZipInfo.cs) is part of csdeployer.
// 
...
namespace Oetools.Utilities.Archive.Compression.Zip {
    ...
    public class ZipInfo : ArchiveInfo {
        ...
        /// </param>
        /// <returns>
        ///     A list of <see cref="ZipFileInfo" /> objects, each containing
