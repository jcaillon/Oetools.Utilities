...
// This file (CompressionEngine.cs) is part of csdeployer.
// 
    ...
    public abstract class CompressionEngine : IDisposable {
        ...
        public virtual long FindArchiveOffset(Stream stream) {
            ...
            for (long offset = 0; offset <= length - sectionSize; offset += sectionSize) {
                ...
                if (IsArchive(stream)) return offset;
            }
        ...
        public IList<string> GetFiles(
            ...
            for (var i = 0; i < files.Count; i++) fileNames.Add(files[i].Name);
        ...
        public Stream Unpack(Stream stream, string path) {
            ...
            var extractStream = streamContext.FileStream;
        ...
        public static void DosDateAndTimeToDateTime(short dosDate, short dosTime, out DateTime dateTime) {
            if (dosDate == 0 && dosTime == 0) {
                ...
                dateTime = DosDateTime.DosDateTimeToDateTimeUtc((ushort) dosDate, (ushort) dosTime);
            }
        }
        ...
        public static void DateTimeToDosDateAndTime(DateTime dateTime, out short dosDate, out short dosTime) {
            DosDateTime.DateTimeToDosDateTimeUtc(dateTime, out ushort fatDate, out ushort fatTime);
            dosDate = (short) fatDate;
            dosTime = (short) fatTime;
        }
    }
}