...
namespace Oetools.Utilities.Ftp {
    ...
    public enum EsslSupportMode {
        ...
        /// <summary>
        ///     Requests a SSL/TLS connection on both control and data channels, implies <see cref="ControlChannelRequested" /> and
        ///     <see cref="DataChannelRequested" />.
        ...
        /// <summary>
        ///     Requires a SSL/TLS connection on both control and data channels, implies <see cref="ControlChannelRequired" /> and
        ///     <see cref="DataChannelRequired" />.
        /// </summary>
    ...
    public enum EPatternStyle {
        ...
        /// <summary>
        ///     Interpret as wildcard, where <c>*</c> means 0 or more chars having any value and <c>?</c> means one char having any
        ///     value.
        /// </summary>
        Wildcard,
    ...
    ///     The main goal of this class is to provide a complete and easy to use FTP client connection, implementing SSL/TLS
    ///     extension
    ...
    public sealed partial class FtpsClient : IDisposable {
        ...
        private Stack<string> _currDirStack = new Stack<string>();
        ...
        /// </summary>
        public EsslSupportMode SslSupportRequestedMode { get; private set; }

        /// <summary>
        ///     The current SSL/TLS support level.
        /// </summary>
        public EsslSupportMode SslSupportCurrentMode { get; private set; }
        ...
        /// <summary>
        ///     The key exchange, hash and cipher algorithms used by the SSL/TLS connection or <c>null</c> if encryption is not
        ///     used.
        /// </summary>
        ...
        /// <param name="sslMinHashAlgStrength"></param>
        /// <param name="timeout">Connection timeout in ms. <c>null</c> can be specifiad to keep the default value of 120s.</param>
        /// <param name="useCtrlEndPointAddressForData">
        ///     <c>true</c> to use the control channel remote address for data connections
        ///     instead of the address returned by PASV
        /// </param>
        /// <returns>The text of the \"welcome message\" sent by the server.</returns>
        public string Connect(string hostname, int port, NetworkCredential credential, EsslSupportMode sslSupportMode,
            RemoteCertificateValidationCallback userValidateServerCertificate, X509Certificate x509ClientCert,
        ...
        /// <returns>
        ///     The file transmission size in bytes, based on the current transfer mode or <c>null</c> if the SIZE command is
        ///     not supported.
        /// </returns>
        ...
        /// <summary>
        ///     Stores a remote file, returning a <see cref="FtpStream" /> to be used for writing the file contents. Call
        ///     <see cref="FtpStream.Close" /> on the stream once done.
        ...
        ///     Please use <see cref="GetShortDirectoryList(string)" /> or <see cref="GetDirectoryListUnparsed(string)" /> for more
        ...
        /// <summary>
        ///     Returns a list of the contents form the given directory. A parsing is performed on the data returned fronm the LIST
        ///     command.
        /// </summary>
        /// <param name="remoteDirName"></param>
        /// <returns></returns>
        /// <remarks>
        ///     Please use <see cref="GetShortDirectoryList(string)" /> or <see cref="GetDirectoryListUnparsed(string)" /> in case
        ///     of parsing errors,
        ...
        /// <summary>
        ///     Pushes the current remote directory on a stack, in order to easily restore it later calling
        ///     <see cref="PopCurrentDirectory" />.
        /// </summary>
        ...
        /// <summary>
        ///     Returns the modification time of the given remote file or <c>null</c> if the MDTM feature is not supported by the
        ///     server.
        /// </summary>
        /// <param name="remoteFileName"></param>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Set the language used by the server during the current connection. Please check the features returned by GetFeatues
        ///     for a list of
        ...
        /// <summary>
        ///     Workaround needed because it is not possible to determine if a symlink is a directory or a file based on the UNIX
