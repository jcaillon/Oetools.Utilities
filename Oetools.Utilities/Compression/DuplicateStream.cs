...
// This file (DuplicateStream.cs) is part of csdeployer.
// 
...
namespace Oetools.Utilities.Compression {
    ...
    public class DuplicateStream : Stream {
        ...
        public static Stream OriginalStream(Stream stream) {
            var dupStream = stream as DuplicateStream;
        ...
        public override int Read(byte[] buffer, int offset, int count) {
            var saveSourcePosition = Source.Position;
        ...
        public override long Seek(long offset, SeekOrigin origin) {
            ...
            if (origin == SeekOrigin.Current) originPosition = position;
            else if (origin == SeekOrigin.End) originPosition = Length;
