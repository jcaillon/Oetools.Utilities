...
// This file (CabException.cs) is part of csdeployer.
// 
...
namespace Oetools.Utilities.Compression.Cab {
    ...
    public class CabException : ArchiveException {
        ...
        internal static string GetErrorMessage(int error, int errorCode, bool extracting) {
            ...
            var resourceOffset = extracting ? FDI_ERROR_RESOURCE_OFFSET : FCI_ERROR_RESOURCE_OFFSET;
            ...
            if (errorCode != 0) {
                ...
                var msg2 = ErrorResources.GetString(GENERIC_ERROR_RESOURCE, CultureInfo.CurrentCulture);
