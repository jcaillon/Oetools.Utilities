...
// This file (CabInfo.cs) is part of csdeployer.
// 
...
namespace Oetools.Utilities.Compression.Cab {
    ...
    public class CabInfo : ArchiveInfo {
        ...
        /// </summary>
        /// <returns>
        ///     A list of <see cref="CabFileInfo" /> objects, each
        ///     containing information about a file in the archive.
        /// </returns>
        public new IList<CabFileInfo> GetFiles() {
            var files = base.GetFiles();
            var cabFiles = new List<CabFileInfo>(files.Count);
