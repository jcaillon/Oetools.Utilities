...
// This file (ArchiveFileInfo.cs) is part of csdeployer.
// 
    ...
    public abstract class ArchiveFileInfo : FileSystemInfo {
        ...
        public override string FullName {
            get {
                ...
                if (Archive != null) fullName = System.IO.Path.Combine(ArchiveName, fullName);
        ...
        public new void Refresh() {
            ...
            if (Archive != null) {
                ...
                var updatedFile = Archive.GetFile(filePath);
                if (updatedFile == null)
        ...
        ///     If true, <paramref name="destFileName" />
        ///     will be overwritten if it exists.
        /// </param>
        /// <exception cref="IOException">
        ///     <paramref name="overwrite" /> is false
        ///     and <paramref name="destFileName" /> exists.
        /// </exception>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "dest")]
        public void CopyTo(string destFileName, bool overwrite) {
            if (destFileName == null) throw new ArgumentNullException("destFileName");

            if (!overwrite && File.Exists(destFileName)) throw new IOException();

            if (Archive == null) throw new InvalidOperationException();
