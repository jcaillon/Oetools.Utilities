...
// This file (ArchiveInfo.cs) is part of csdeployer.
// 
...
namespace Oetools.Utilities.Compression {
    ...
    public abstract class ArchiveInfo : FileSystemInfo {
        ...
        /// </summary>
        /// <returns>
        ///     A list of <see cref="ArchiveFileInfo" /> objects, each
        ...
        /// </param>
        /// <returns>
        ///     A list of <see cref="ArchiveFileInfo" /> objects, each containing
        ...
        /// </param>
        /// <remarks>
        ///     If <paramref name="destFileName" /> already exists,
        ...
        ///     <paramref name="destFileNames" />.
        /// </param>
        /// <param name="destFileNames">
        ...
        ///     <p>
        ///         The <paramref name="destDirectory" /> and
        ///         <paramref name="destFileNames" /> parameters cannot both be null.
        ///     </p>
        /// </remarks>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "dest")]
        ...
        public void UnpackFiles(
            ...
            if (destFileNames == null) {
                if (destDirectory == null) throw new ArgumentNullException("destFileNames");

                destFileNames = fileNames;
            }

            if (destFileNames.Count != fileNames.Count) throw new ArgumentOutOfRangeException("destFileNames");
        ...
        ///     paths in <paramref name="fileNames" />.
        /// </param>
        /// <param name="progressHandler">
        ///     Handler for receiving progress
        ///     information; this may be null if progress is not desired.
        ...
        public Stream OpenRead(string fileName) {
            ...
            var compressionEngine = CreateCompressionEngine();
            var fileStream = compressionEngine.Unpack(archiveStream, fileName);
        ...
        public void Pack(
            ...
            EventHandler<ArchiveProgressEventArgs> progressHandler) {
            var files = GetRelativeFilePathsInDirectoryTree(
        ...
        ///     for any relative paths in <paramref name="sourceFileNames" />.
        /// </param>
        ...
        public void PackFiles(
            ...
            CompressionLevel compLevel,
            EventHandler<ArchiveProgressEventArgs> progressHandler) {
            if (sourceFileNames == null) throw new ArgumentNullException("sourceFileNames");

            if (fileNames == null) {
                var fileNamesArray = new string[sourceFileNames.Count];
                for (var i = 0; i < sourceFileNames.Count; i++) fileNamesArray[i] = Path.GetFileName(sourceFileNames[i]);
        ...
        ///     This parameter may be null, but if
        ///     specified it is the root directory
        ///     for any relative paths in <paramref name="fileNames" />.
        /// </param>
        /// <param name="fileNames">
        ///     A mapping from internal file paths to
        ///     external file paths.
        ...
        private static IDictionary<string, string> CreateStringDictionary(
            ...
            for (var i = 0; i < keys.Count; i++) stringDict.Add(keys[i], values[i]);
        ...
        private IList<ArchiveFileInfo> InternalGetFiles(Predicate<string> fileFilter) {
            using (var compressionEngine = CreateCompressionEngine()) {
                ...
                for (var i = 0; i < files.Count; i++) files[i].Archive = this;
